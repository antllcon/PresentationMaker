...
import {changePresentationTitle, removeSlide, addSlide, addTextToSlide, moveSlide, removeObjectFromSlide, changeObjectPosition, changeSlideBackground, changeTextContent, changeTextFontFamily, changeTextSize} from "./functions";
